...
const FrontDesk = (() => {
  ...
  function _regCardHtml(reg) {
    ...
    for (let i = 0; i < mQty; i++) {
      ...
      rows.push(_slotRowHtml(reg.RegistrationID, slotId, label, key, isIn, 'member', '', m));
    }
  ...
  function _slotRowHtml(regId, slotId, label, memberKey, isIn, type, guestName, memberObj) {
