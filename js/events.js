...
.stats-bar-stacked{display:flex;height:10px;border-radius:5px;overflow:hidden;background:#e5e7eb;margin-bottom:6px}
.stats-bar-seg{height:100%}
.stats-bar-track{height:8px;border-radius:4px;background:#e5e7eb;overflow:hidden;margin-bottom:6px}
...
.stats-dot-kids,.stats-bar-seg.stats-dot-kids{background:#f59e0b}
